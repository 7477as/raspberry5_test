...
typedef enum {
    STDF_MVC_LOG_LVL_DEBUG = 0,
    STDF_MVC_LOG_LVL_INFO,
    STDF_MVC_LOG_LVL_WARN,
    STDF_MVC_LOG_LVL_ERROR,
} stdf_mvc_log_lvl_t;

typedef void (*stdf_mvc_post_async_cb_t)(void *payload);
typedef void (*stdf_mvc_log_fn_t)(stdf_mvc_log_lvl_t lvl, const char *fmt, va_list ap);
